...
Item {
    ...
    Loader {
        ...
        onLoaded: {
            item.anchors.fill = Qt.binding(function(){return mainloader})
        }
    }
                    ...
                    Label {
                        ...
                        Connections {
                            ...
                            function onFolderChanged() {
                                pathLbl.text = pathLbl.getCurrentFolderPath()
                            }
                        }
                        Component.onCompleted: {
                            text = getCurrentFolderPath()
                        }
                ...
                ListView {
                    ...
                    Component {
                        ...
                        Rectangle {
                            ...
                            property var asset: SofaApplication.currentProject.getAsset(folderModel.get(index, "filePath"))
                                ...
                                RowLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        Image {
                                            ...
                                            source: {
                                                if (fileIsDir) {
                                                    return "qrc:/icon/ICON_FILE_FOLDER.png"
                                                } else {
                                                    if (wrapper.asset) return wrapper.asset.iconPath
                                                    return "qrc:/icon/ICON_FILE_BLANK.png";
                                                }
                                            }
                                            anchors.verticalCenter: parent.verticalCenter
                                        }
